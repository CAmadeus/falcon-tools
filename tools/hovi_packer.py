...
def generate_firmware(blob0_path, blob1_path, blob1_auth_hash, output_path):
    empty_key = binascii.unhexlify("00000000000000000000000000000000")
    ...
    debug_key = empty_key
    blob0_auth_hash = empty_key
    blob2_auth_hash = empty_key
    blob2_aes_iv = empty_key
...
def main(args):
    if len(args) != 4:
        ...
        generate_firmware(args[0], args[1], binascii.unhexlify(args[2]), args[3])
